 ...
 * y la cinta de clientes pierde el pulso.
 */
...
@Component({
  selector: 'app-client-mark',
  templateUrl: './client-mark.component.html',
  styleUrl: './client-mark.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ClientMarkComponent {
  ...
  /** Sin color de marca declarado, la marca se enciende con el acento de la casa. */
  readonly brandColor = computed(() => this.client().brandColor ?? 'var(--accent)');
}
